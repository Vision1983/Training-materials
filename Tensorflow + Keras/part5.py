...
pokročilá neuronová sít s optimalizací, načtení předzpracovaných dat z pickle + import vizualizace Tensorboard
Z vizualizace lze zvolit nejvhodnější model
"""
